...
public open class JavaCounterParser(input: TokenStream) : Parser(input) {
    ...
    public object Tokens {
        ...
        public const val OPERATOR: Int = 19
        public const val IDENTIFIER: Int = 20
        public const val VALUE: Int = 21
        public const val WS: Int = 22
    }
    ...
    public fun javaFile(): JavaFileContext {
        ...
        try {
            ...
            while ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 3661824L) != 0L)) {
                this.state = 28
                errorHandler.sync(this)
    ...
    public fun classDeclaration(): ClassDeclarationContext {
        ...
        try {
            ...
            if (_la == Tokens.T__0) {
                ...
                if ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 1171456L) != 0L)) {
                    this.state = 41
                    declaration()
            ...
            if (_la == Tokens.T__3) {
                ...
                if ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 3276800L) != 0L)) {
                    this.state = 57
                    expression(0)
    ...
    public fun classBody(): ClassBodyContext {
        ...
        try {
            ...
            while ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 1171456L) != 0L)) {
                this.state = 75
                declaration()
    ...
    public fun functionDeclaration(): FunctionDeclarationContext {
        ...
        try {
            ...
            if (_la == Tokens.JAVA_FUNCTION_MODIFIERS) {
                this.state = 101
                ...
                if (_alt == 1 ) {
                    ...
                    when (interpreter.adaptivePredict(_input, 24, context)) {
                        1 -> {
                            ...
                            while ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 3276800L) != 0L)) {
                                this.state = 165
                                expression(0)
