...
public open class CounterParser(input: TokenStream) : Parser(input) {
    private companion object {
        ...
        private val LITERAL_NAMES: Array<String?> = arrayOf(
            null, "'('", "','", "')'", "':'", "'{'", "'}'", "'='", null, 
            null, null, "'class'", "'fun'", "'val'", "'var'", "'interface'", 
            null, null, "'return'"
        )

        private val SYMBOLIC_NAMES: Array<String?> = arrayOf(
            null, null, null, null, null, null, null, null, "LINE_COMMENT", 
    ...
    public object Tokens {
        ...
        public const val LINE_COMMENT: Int = 8
        public const val BLOCK_COMMENT: Int = 9
        public const val PACKAGES: Int = 10
        public const val KOTLIN_CLASS: Int = 11
        public const val KOTLIN_FUN: Int = 12
        public const val KOTLIN_VAL: Int = 13
        public const val KOTLIN_VAR: Int = 14
        public const val KOTLIN_INTERFACE_IDENTIFIER: Int = 15
        public const val KOTLIN_TYPE: Int = 16
        public const val STRING_LITERALS: Int = 17
        public const val RETURN: Int = 18
        public const val IDENTIFIER: Int = 19
        public const val WS: Int = 20
    }
    ...
    public fun kotlinFile(): KotlinFileContext {
        ...
        try {
            ...
            while ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 817152L) != 0L)) {
                this.state = 30
                errorHandler.sync(this)
    ...
    public fun classDeclaration(): ClassDeclarationContext {
        ...
        try {
            ...
            if (_la == Tokens.T__0) {
                ...
                if ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 30720L) != 0L)) {
                    this.state = 40
                    declaration()
    ...
    public fun classBody(): ClassBodyContext {
        ...
        try {
            ...
            while ((((_la) and 0x3f.inv()) == 0 && ((1L shl _la) and 30720L) != 0L)) {
                this.state = 74
                declaration()
